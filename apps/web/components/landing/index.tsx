...
const index = () => {
    ...
    const teams = [
        { name: "Yasin Torun", title: "Kurucu", image: "https://avatars.githubusercontent.com/u/58103649?s=400" },
    ]

    return (
        <main>
            <section className={cn("relative h-[calc(100vh-80px)] md:py-0 py-36 overflow-hidden flex items-center ", styles.bgAnimation)}>
                        ...
                        <div className="lg:ms-8">
                            <div className="grid grid-cols-1 gap-[30px]">
                                {editorFeatures.map((feature, index) => (
                                    <div key={index} className="group flex items-center relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-gray-50 dark:bg-slate-800 hover:bg-primary/10 dark:hover:bg-primary/50 transition-all duration-500 ease-in-out">
            ...
            <section className="relative md:py-24 py-16 overflow-hidden">
                ...
                <div className='grid place-items-center'>
                    {teams.map((team, index) => (
                        <div key={index} className="mt-10 gap-[30px]">
                            <div className="relative">
                                <img src={team.image} className="w-32 h-32 rounded-full shadow-md dark:shadow-gray-800" alt="" />
                            </div>
                            <div className='text-center mt-2'>
                                <h5 className="text-xl font-semibold">{team.name}</h5>
