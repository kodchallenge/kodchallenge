import { CheckCircledIcon, PlayIcon } from '@kod/icons'
import { problemDifficulty } from '@kod/lib/common/problem-difficulty'
import { RouterOutputs } from '@kod/server/trpc'
import { Avatar, AvatarFallback, AvatarImage, Badge, Button, Card, CardContent, CardDescription, CardHeader, CardTitle, cn } from '@kod/ui'
